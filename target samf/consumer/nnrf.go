...
func BuildNFInstance(context *samf_context.SAMFContext) models.NfProfile {
	var profile models.NfProfile
	config := factory.SamfConfig
...
func SendRegisterNFInstance(nrfUri, nfInstanceId string, profile models.NfProfile) (string, string, error) {
	...
	for {
		...
		if err != nil || res == nil {
			// TODO : add log
			fmt.Println(fmt.Errorf("SAMF register to NRF Error[%s]", err.Error()))
...
func SendDeregisterNFInstance() (problemDetails *models.ProblemDetails, err error) {
	...
	samfSelf := samf_context.SAMF_Self()
	// Set client and set url
	configuration := Nnrf_NFManagement.NewConfiguration()
	configuration.SetBasePath(samfSelf.NrfUri)
	client := Nnrf_NFManagement.NewAPIClient(configuration)

	var res *http.Response

	res, err = client.NFInstanceIDDocumentApi.DeregisterNFInstance(context.Background(), samfSelf.NfId)
	if err == nil {
		return
	} else if res != nil {
		defer func() {
...
// 		NfInstanceId:  samf_context.SAMF_Self().NfInstanceID,
// 		NfType:        "SAMF",
// 		NfStatus:      models.NfStatus_REGISTERED,
// 		Ipv4Addresses: []string{samf_context.SAMF_Self().RegisterIPv4},
// 	}
...
// 			RegisterNFInstance(context.TODO(), samf_context.SAMF_Self().NfInstanceID, profile)
// 		if err != nil || res == nil {
// 			logger.ConsumerLog.Infof("SAMF register to NRF Error[%s]", err.Error())
// 			time.Sleep(2 * time.Second)
// 			continue
// 		}
// 		defer func() {
...
// 			samf_context.SAMF_Self().NfInstanceID = resourceUri[strings.LastIndex(resourceUri, "/")+1:]
// 			break
// 		} else {
...
// 	logger.InitLog.Infof("SAMF Registration to NRF %v", rep)
// 	return nil
// }
...
// 	return fmt.Errorf("[SAMF] Retry NF Registration has meet maximum")
// }

// func SendNFDeregistration() error {
// 	// Check data (Use RESTful DELETE)
// 	res, localErr := samf_context.SAMF_Self().
// 		NFManagementClient.
// 		NFInstanceIDDocumentApi.
// 		DeregisterNFInstance(context.TODO(), samf_context.SAMF_Self().NfInstanceID)
// 	if localErr != nil {
