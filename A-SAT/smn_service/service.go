...
func IntraHOReq(c *gin.Context) { //TODO: Change input data 'data' to appropriate attribute
	...
	*/
	...
	http := &http.Client{Transport: transport}
	resp, err := http.Post("http://localhost:24243/smn-service/v1/IntraHOReport", "application/json", bytes.NewBuffer([]byte(jsonStr)))
	if err != nil {
		fmt.Println("error: %v", err)
	} else {
		fmt.Println(resp.Header)
...
func IntraHOStateExchangeReq(c *gin.Context) { //TODO: Change input data 'data' to appropriate attribute
	...
	*/
	...
	resp, err := http.Post("http://localhost:24243/smn-service/v1/IntraHOStateExchangeResp", "application/json", bytes.NewBuffer([]byte(jsonStr)))
	if err != nil {
		fmt.Println("error: %v", err)
	} else {
		fmt.Println(resp.Header)
...
func IntraReleaseReq(c *gin.Context) { //TODO: Change input data 'data' to appropriate attribute
	/*
		Add Propagation Delay
	*/
	log.Print("##############################\n")
	log.Print("6. Release Resource\n")
	/*
	   Add Release Resource Code
	*/
	log.Print("##############################\n")

}

func InterReleaseReq(c *gin.Context) { //TODO: Change input data 'data' to appropriate attribute
	/*
		Add Propagation Delay
	*/
	log.Print("##############################\n")
	log.Print("7. Release Resource\n")
	/*
	   Add Release Resource Code
	*/
	log.Print("##############################\n")
...
func InterHOReq(c *gin.Context) { //TODO: Change input data 'data' to appropriate attribute
	...
	*/
	...
	http := &http.Client{Transport: transport}
	resp, err := http.Post("http://localhost:24250/smn-service/v1/InterHOReport", "application/json", bytes.NewBuffer([]byte(jsonStr)))
	if err != nil {
		fmt.Println("error: %v", err)
	} else {
		fmt.Println(resp.Header)
...
func InterHOStateExchageReq(c *gin.Context) { //TODO: Change input data 'data' to appropriate attribute
	...
	*/
	...
	resp, err := http.Post("http://localhost:24250/smn-service/v1/InterHOStateExchageResp", "application/json", bytes.NewBuffer([]byte(jsonStr)))
	if err != nil {
		fmt.Println("error: %v", err)
	} else {
		fmt.Println(resp.Header)
